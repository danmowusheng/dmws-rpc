...
import com.dmws.rpc.core.config.RegistryConfig;
import com.dmws.rpc.core.config.ServiceConfig;
import com.dmws.rpc.core.proxy.RpcClientProxy;
import com.dmws.rpc.core.proxy.RpcServiceCache;
...
public class ServiceBeanPostProcessor implements BeanPostProcessor {
    ...
    /**
     * 初始化以后扫描所有的RPC调用，并生成代理类
     * 当调用接口时，这个代理类就会找到服务，并请求到结果返回
     * @param bean
     * @param beanName
     * @return
     * @throws BeansException
        ...
        for (Field field : fields){
            ...
            if (rpcReference != null){
                ...
                try {
                    ...
                    log.error("field.set error. com.dmws.rpc.demo.client.api.bean={}, field={}", bean.getClass(), field.getName(), e);
                }
            }
        }
        return bean;
    ...
    private URL buildServiceURL(Object bean, RpcService rpcService) {
        ...
        return URL.builder().protocol("dmws-rpc")
