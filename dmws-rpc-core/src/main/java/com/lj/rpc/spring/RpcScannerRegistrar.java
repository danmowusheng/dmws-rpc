...
import com.lj.rpc.annotation.RpcScan;
...
public class RpcScannerRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        RpcScanner innerScanner = new RpcScanner(registry, Component.class, Service.class, (Class<? extends Annotation>) Resource.class);
